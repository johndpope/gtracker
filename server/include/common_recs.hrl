...
-record(track, {dev_name, id, name = undef, track_server, start = undef, stop = undef, status = opened}).
-record(track_stat, {track_id, subs = [], status = opened, calc_speed = false, start = undef, stop = undef, length = 0, avg_speed = 0, coord_count = 0}).
